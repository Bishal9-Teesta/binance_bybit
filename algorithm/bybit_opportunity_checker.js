...
const bybit_opportunity_checker = (binance_ask_pair_array, bybit_bid_pair_array, future_price, expiry_in_days) => {
    ...
    while (should_continue) {
        ...
        if (spread > global.SPREAD_MARGIN) {
            ...
            accumulated_opportunity += opportunity - ( binance_fee + bybit_fee + binance_settlement_fee + bybit_settlement_fee )
            accumulated_sell_premium += ( future_price * minimum_quantity ) * global.BYBIT.option_sell_margin

            const data_to_log = `

            Future Price:                                   ${future_price}
            Binance Bid Price:                              ${binance_ask_price}
            Bybit Ask Price:                                ${bybit_bid_price}
    ...
    if (accumulated_opportunity > 0) {
        ...
        if (cagr > 30) {
            ...
            final.push({
                ...
                binance_ask_pair_array,
                bybit_bid_pair_array
            })
        }
    }
